...
from app.common.schema import PredictAllergy
from app.models.allergy import get_similarity_out, ignore_word_query, insert_allergy, insert_history, update_allergy
